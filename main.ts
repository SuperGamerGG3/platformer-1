...
controller.combos.attachCombo("udlrududlrlrudlr", function () {
    currentLevel = 17
    startNextLevel()
})
info.onLifeZero(function () {
    ...
    music.stopAllSounds()
    tiles.setTileAt(mySprite.tilemapLocation(), assets.tile`myTile29`)
    tiles.placeOnRandomTile(mySprite, assets.tile`tile3`)
    music.play(music.createSong(assets.song`Come On Lets Go_ - Mainlands Theme`), music.PlaybackMode.LoopingInBackground)
    info.setLife(5)
})
 ...
 * 
 * If at any time you want to contact me, call 210-956-5032 or email me at michael.vichique@students.nisd.net or vichiquemichael@gmail.com.
 */
function startNextLevel () {
    ...
    if (currentLevel == 1) {
        ...
        music.play(music.createSong(assets.song`Mainlands`), music.PlaybackMode.UntilDone)
        ...
        music.play(music.stringPlayable("F E A G B A G A ", 120), music.PlaybackMode.LoopingInBackground)
    } else if (currentLevel == 16) {
        scene.setBackgroundColor(13)
        tiles.setTilemap(tilemap`level25`)
        music.play(music.createSong(hex``), music.PlaybackMode.LoopingInBackground)
...
controller.menu.onEvent(ControllerButtonEvent.Pressed, function () {
    game.showLongText("Reset Cartridge. Ok?", DialogLayout.Bottom)
    pauseUntil(() => controller.anyButton.isPressed())
